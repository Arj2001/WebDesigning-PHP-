        ...
        <div class="container-fluid">
            ...
            <form action="" method='post' enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" style="width: 45%;" required>
                </div>
                <div class="form-group">
                ...
                <div class="from-group">
                    ...
                    <div class=" form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" id="free" name="free" value="TRUE" required>Yes
                        </label>
                        <label class="form-check-label ml-1">
                            <input type="radio" class="form-check-input" id="free1" name="free" value="FALSE" required>No
                        </label>
                    </div>
                </div>
