...
<body>
    ...
    <div class="container mt-5 py-5">
        <form method="get" action="search.php" class="d-flex justify-content-left">
            <input type="search" name="search" class="form-control" style="width:30%" placeholder="search..." value="<?php echo $search; ?>">
